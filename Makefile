...
pov:
	cp $(ciPATH)/CI_POV_writer.cpp .
	$(COMPILE_COMMAND) -o CI_vis CI_POV_writer.cpp ./modules/PhysiCell_POV.cpp $(BioFVM_OBJECTS) $(pugixml_OBJECTS)
	$(COMPILE_COMMAND) -o CI_script $(ciPATH)/CI_script.cpp  
	rm CI_POV_writer.cpp
